 ...
 */
class Version20160827165134 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus_note ADD CONSTRAINT '
                . 'FK_6478FCEC85C4074C FOREIGN KEY (genus_id) '
                . 'REFERENCES genus (id)');
        $this->addSql('CREATE INDEX IDX_6478FCEC85C4074C '
                . 'ON genus_note (genus_id)');
    }
